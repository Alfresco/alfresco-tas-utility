	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<br />
				<style type='text/css'>
					#page-content h3 {font-size: 13px; color: #000000;
					padding: 0 0 0 5px;
					font-weight: bolder; text-align: left; }
					#page-content table * {padding: 2px 10px 2px 10px;}
					#page-content
					table {table-layout: fixed; width: 100%; border-spacing: 0px;
					font-size: 12px; margin: 10px 0 10px 20px;}
					#page-content table
					td,#page-content table th {border-width: 1px; border-style:
					solid;
					border-color: #E0DFD5; word-wrap: break-word;}
					#page-content
					{margin: 10px;}
					.scenario_line_failure { solid #AA6270; background:
					#F09499;; color: black; font-weight:
					bolder; font-size: 12px;
					padding:0 }
					.scenario_line_passed { font-size: 12px; background:
					#F09499; padding:0}
					.scenario_line_test { font-size: 14px;
					background: #E0DFD5;
					padding:0 }
					.scenario_line_action { font-size:
					12px; background: #E1F5A9; padding:0 }
					.scenario_line_loading{
					font-size: 12px; background: #E0F2F7;
					padding:0 }
					body {color: #000;
					margin: 0; font-size: 13px; font-family: Arial; }
					p {margin: 0 0
					10px 0; }
					p, h2, h3 {margin: 0; padding: 0; }
					table.summary_details
					th { font-weight: bold; text-align: left; background: #F1F0EC;
					color: #000; font-size: 12px; border-bottom: 1px solid #E0DFD5;
					border-left: 1px solid #E0DFD5;}
					table.summary_details1 {
					table-layout: fixed; width: 90%;; border-right: 1px solid
					...
					10%;}
					.list4 {width: 20%;}
					div#summary-module h2 { text-align: left;
					color: ##000; height: 45px; font-size:
					12px; margin: 0px 10px 10px
					40px; background: #F1F0EC; width: 50%;}
